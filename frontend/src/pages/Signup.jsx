...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save token and user details (automatic login upon signup)
      ...
      <div className="col-span-12 lg:col-span-6 flex items-center justify-center p-6 md:p-12 relative">
        ...
        >
          <div className="text-center mb-8">
            <span className="px-3 py-1 text-[10px] rounded-full bg-cyan-400/20 text-cyan-300 font-bold uppercase tracking-wider">
              Registration
            </span>
            ...
            <p className="text-xs text-slate-400 mt-2">
              Sign up to unlock the full potential of your custom 3D blueprints.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? (
                ...
                <>
                  <span>🏗️ Initialize Profile</span>
                </>
              )}
            </button>
          </form>
